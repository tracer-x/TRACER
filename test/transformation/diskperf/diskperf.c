...
int DiskPerfIoCompletion(int DiskPerfIoCompletion_DeviceObject , int DiskPerfIoCompletion_Irp , int DiskPerfIoCompletion_Context ) 
{ int DiskPerfIoCompletion_irpStack__MajorFunction ;
  int DiskPerfIoCompletion_partitionCounters__BytesRead__QuadPart ;
  int DiskPerfIoCompletion_Irp__IoStatus__Information ;
  int DiskPerfIoCompletion_partitionCounters__ReadCount ;
  int DiskPerfIoCompletion_partitionCounters__ReadTime__QuadPart ;
  int DiskPerfIoCompletion_difference__QuadPart ;
  int DiskPerfIoCompletion_partitionCounters__BytesWritten__QuadPart ;
  int DiskPerfIoCompletion_partitionCounters__WriteCount ;
  int DiskPerfIoCompletion_partitionCounters__WriteTime__QuadPart ;
  int DiskPerfIoCompletion_Irp__Flags ;
  int DiskPerfIoCompletion_partitionCounters__SplitCount ;
  int DiskPerfIoCompletion_Irp__PendingReturned ;
  int DiskPerfIoCompletion_partitionCounters ;
  int DiskPerfIoCompletion_queueLen ;
  int retres18 ;

  {
    if ((DiskPerfIoCompletion_partitionCounters >= 0) && (DiskPerfIoCompletion_partitionCounters <= 0)) {
      retres18 = 0;
    }
    else {
      if (DiskPerfIoCompletion_queueLen < 0) {

      }
      if ((DiskPerfIoCompletion_queueLen >= 0) && (DiskPerfIoCompletion_queueLen <= 0)) {

      }
      if ((DiskPerfIoCompletion_irpStack__MajorFunction >= 3) && (DiskPerfIoCompletion_irpStack__MajorFunction <= 3)) {
        DiskPerfIoCompletion_partitionCounters__BytesRead__QuadPart = DiskPerfIoCompletion_partitionCounters__BytesRead__QuadPart + DiskPerfIoCompletion_Irp__IoStatus__Information;
        DiskPerfIoCompletion_partitionCounters__ReadCount = DiskPerfIoCompletion_partitionCounters__ReadCount + 1;
        DiskPerfIoCompletion_partitionCounters__ReadTime__QuadPart = DiskPerfIoCompletion_partitionCounters__ReadTime__QuadPart + DiskPerfIoCompletion_difference__QuadPart;
      } else {
        DiskPerfIoCompletion_partitionCounters__BytesWritten__QuadPart = DiskPerfIoCompletion_partitionCounters__BytesWritten__QuadPart + DiskPerfIoCompletion_Irp__IoStatus__Information;
        DiskPerfIoCompletion_partitionCounters__WriteCount = DiskPerfIoCompletion_partitionCounters__WriteCount + 1;
        DiskPerfIoCompletion_partitionCounters__WriteTime__QuadPart = DiskPerfIoCompletion_partitionCounters__WriteTime__QuadPart + DiskPerfIoCompletion_difference__QuadPart;
      }
      if ((DiskPerfIoCompletion_Irp__Flags > 8) || (DiskPerfIoCompletion_Irp__Flags < 8)) {
        DiskPerfIoCompletion_partitionCounters__SplitCount = DiskPerfIoCompletion_partitionCounters__SplitCount + 1;
      }
      if ((DiskPerfIoCompletion_Irp__PendingReturned > 0) || (DiskPerfIoCompletion_Irp__PendingReturned < 0)) {
...
void DiskPerfUnload(int DiskPerfUnload_DriverObject ) 
{ 
...
{ int DiskPerfRegisterDevice_DeviceObject__DeviceExtension ;
  ...
  int DiskPerfRegisterDevice_volumeNumber__VolumeManagerName__0 ;
              ...
              if (DiskPerfRegisterDevice_status < 0) {
                ...
                if ((DiskPerfRegisterDevice_irp >= 0) && (DiskPerfRegisterDevice_irp <= 0)) {
                  ...
                  if (DiskPerfRegisterDevice_status < 0) {
                    ...
                    if ((DiskPerfRegisterDevice_volumeNumber__VolumeManagerName__0 >= 0) && (DiskPerfRegisterDevice_volumeNumber__VolumeManagerName__0 <= 0)) {
                      if (DiskPerfRegisterDevice_status >= 0) {
