...
{ int FloppyStartDevice_DeviceObject__DeviceExtension ;
  ...
  int FloppyStartDevice_fdcInfo__BusType ;
  int FloppyStartDevice_fdcInfo__ControllerNumber ;
  int FloppyStartDevice_fdcInfo__UnitNumber ;
  int FloppyStartDevice_fdcInfo__BusNumber ;
...
{ int IoDeleteSymbolicLink_tmp_ndt_6 ;
  ...
  {
    IoDeleteSymbolicLink_tmp_ndt_6 = __VERIFIER_nondet_int();
    if ((IoDeleteSymbolicLink_tmp_ndt_6 >= 0) && (IoDeleteSymbolicLink_tmp_ndt_6 <= 0)) {
      retres3 = 0;
    } else {
      retres3 = -1073741823;
    }
...
int IoQueryDeviceDescription(int IoQueryDeviceDescription_BusType , int IoQueryDeviceDescription_BusNumber , int IoQueryDeviceDescription_ControllerType , int IoQueryDeviceDescription_ControllerNumber , int IoQueryDeviceDescription_PeripheralType , int IoQueryDeviceDescription_PeripheralNumber , int IoQueryDeviceDescription_CalloutRoutine , int IoQueryDeviceDescription_Context ) 
{ int IoQueryDeviceDescription_tmp_ndt_7 ;
  int retres10 ;

  {
    IoQueryDeviceDescription_tmp_ndt_7 = __VERIFIER_nondet_int();
    if ((IoQueryDeviceDescription_tmp_ndt_7 >= 0) && (IoQueryDeviceDescription_tmp_ndt_7 <= 0)) {
      retres10 = 0;
    } else {
      retres10 = -1073741823;
    }
...
{ int IoSetDeviceInterfaceState_tmp_ndt_9 ;
  ...
  {
    IoSetDeviceInterfaceState_tmp_ndt_9 = __VERIFIER_nondet_int();
    if ((IoSetDeviceInterfaceState_tmp_ndt_9 >= 0) && (IoSetDeviceInterfaceState_tmp_ndt_9 <= 0)) {
      retres4 = 0;
    } else {
      retres4 = -1073741823;
    }
...
{ int KeWaitForSingleObject_tmp_ndt_12 ;
...

  {
    ...
    KeWaitForSingleObject_tmp_ndt_12 = __VERIFIER_nondet_int();
    if ((KeWaitForSingleObject_tmp_ndt_12 >= 0) && (KeWaitForSingleObject_tmp_ndt_12 <= 0)) {
      retres7 = 0;
    } else {
      retres7 = -1073741823;
    }
...
{ int ZwClose_tmp_ndt_15 ;
  ...
  {
    ZwClose_tmp_ndt_15 = __VERIFIER_nondet_int();
    if ((ZwClose_tmp_ndt_15 >= 0) && (ZwClose_tmp_ndt_15 <= 0)) {
      retres3 = 0;
    } else {
      retres3 = -1073741823;
    }
...
{ int FloppyDeviceControl_disketteExtension__HoldNewRequests ;
...

  {
    TRACER_returning = 0;
    TRACER_breaking = 0;
    if ((FloppyDeviceControl_disketteExtension__HoldNewRequests > 0) || (FloppyDeviceControl_disketteExtension__HoldNewRequests < 0)) {
      if ((FloppyDeviceControl_irpSp__Parameters__DeviceIoControl__IoControlCode___1 > FloppyDeviceControl_CIL___Tmp41) || (FloppyDeviceControl_irpSp__Parameters__DeviceIoControl__IoControlCode___1 < FloppyDeviceControl_CIL___Tmp41)) {
    ...
    if (TRACER_returning <= 0) {
      if ((FloppyDeviceControl_disketteExtension__IsRemoved > 0) || (FloppyDeviceControl_disketteExtension__IsRemoved < 0)) {
        ...
        if ((FloppyDeviceControl_disketteExtension__IsStarted >= 0) && (FloppyDeviceControl_disketteExtension__IsStarted <= 0)) {
            ...
            if ((FloppyDeviceControl_irpSp__Parameters__DeviceIoControl__IoControlCode___1 >= FloppyDeviceControl_CIL___Tmp45) && (FloppyDeviceControl_irpSp__Parameters__DeviceIoControl__IoControlCode___1 <= FloppyDeviceControl_CIL___Tmp45)) {
              ...
              if ((FloppyDeviceControl_irpSp__Parameters__DeviceIoControl__IoControlCode___1 >= FloppyDeviceControl_CIL___Tmp50) && (FloppyDeviceControl_irpSp__Parameters__DeviceIoControl__IoControlCode___1 <= FloppyDeviceControl_CIL___Tmp50)) {
                if (FloppyDeviceControl_irpSp__Parameters__DeviceIoControl__InputBufferLength < FloppyDeviceControl_sizeof__FORMAT_PARAMETERS) {
                  ...
                  if ((FloppyDeviceControl_tmp___0 >= 0) && (FloppyDeviceControl_tmp___0 <= 0)) {
                    FloppyDeviceControl_ntStatus = -1073741811;
                  }
                  else {
          ...
          if (TRACER_returning <= 0) {
            ...
            if ((FloppyDeviceControl_CIL___Tmp91 > 259) || (FloppyDeviceControl_CIL___Tmp91 < 259)) {
...
{ int FlCheckFormatParameters_DriveMediaConstants__driveMediaType__MediaType ;
  ...
  {
    if ((FlCheckFormatParameters_DriveMediaConstants__driveMediaType__MediaType > FlCheckFormatParameters_FormatParameters__MediaType) || (FlCheckFormatParameters_DriveMediaConstants__driveMediaType__MediaType < FlCheckFormatParameters_FormatParameters__MediaType)) {
      retres6 = 0;
    } else {
      if ((FlCheckFormatParameters_FAKE_CONDITION > 0) || (FlCheckFormatParameters_FAKE_CONDITION < 0)) {
        retres6 = 0;
      } else {
        retres6 = 1;
      }
...
{ int FloppyQueueRequest_Irp__IoStatus__Status ;
...

  {
    ...
    if ((FloppyQueueRequest_FAKE_CONDITION > 0) || (FloppyQueueRequest_FAKE_CONDITION < 0)) {
