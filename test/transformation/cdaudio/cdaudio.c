...
{ int CdAudio535DeviceControl_Irp__Tail__Overlay__CurrentStackLocation ;
  ...
  int CdAudio535DeviceControl_inputBuffer__StartingM ;
  int CdAudio535DeviceControl_inputBuffer__EndingM ;
  int CdAudio535DeviceControl_inputBuffer__StartingS ;
  int CdAudio535DeviceControl_inputBuffer__EndingS ;
  int CdAudio535DeviceControl_inputBuffer__StartingF ;
  int CdAudio535DeviceControl_inputBuffer__EndingF ;
  int CdAudio535DeviceControl_cdb__PLAY_AUDIO_MSF__OperationCode ;
        ...
        if ((CdAudio535DeviceControl_currentIrpStack__Parameters__DeviceIoControl__IoControlCode >= CdAudio535DeviceControl_CIL___Tmp70) && (CdAudio535DeviceControl_currentIrpStack__Parameters__DeviceIoControl__IoControlCode <= CdAudio535DeviceControl_CIL___Tmp70)) {
          ...
          if ((CdAudio535DeviceControl_currentIrpStack__Parameters__DeviceIoControl__IoControlCode >= CdAudio535DeviceControl_CIL___Tmp75) && (CdAudio535DeviceControl_currentIrpStack__Parameters__DeviceIoControl__IoControlCode <= CdAudio535DeviceControl_CIL___Tmp75)) {
            ...
            if (CdAudio535DeviceControl_currentIrpStack__Parameters__DeviceIoControl__InputBufferLength < CdAudio535DeviceControl_sizeof__CDROM_PLAY_AUDIO_MSF) {
              ...
              if ((CdAudio535DeviceControl_inputBuffer__StartingM >= CdAudio535DeviceControl_inputBuffer__EndingM) && (CdAudio535DeviceControl_inputBuffer__StartingM <= CdAudio535DeviceControl_inputBuffer__EndingM)) {
                if ((CdAudio535DeviceControl_inputBuffer__StartingS >= CdAudio535DeviceControl_inputBuffer__EndingS) && (CdAudio535DeviceControl_inputBuffer__StartingS <= CdAudio535DeviceControl_inputBuffer__EndingS)) {
                  if ((CdAudio535DeviceControl_inputBuffer__StartingF >= CdAudio535DeviceControl_inputBuffer__EndingF) && (CdAudio535DeviceControl_inputBuffer__StartingF <= CdAudio535DeviceControl_inputBuffer__EndingF)) {
              ...
              if (CdAudio535DeviceControl_status >= 0) {
                if ((CdAudio535DeviceControl_cdb__PLAY_AUDIO_MSF__OperationCode >= 71) && (CdAudio535DeviceControl_cdb__PLAY_AUDIO_MSF__OperationCode <= 71)) {
...
{ int AG_SetStatusAndReturn_CIL___Tmp4 ;

  {
    ...
    if ((AG_SetStatusAndReturn_CIL___Tmp4 >= -2147483626) && (AG_SetStatusAndReturn_CIL___Tmp4 <= -2147483626)) {
...
{ int main_pirp__IoStatus__Status ;
...

  {
    ...
    if (main_TRACER_returning <= 0) {
      ...
      main_retres11 = main_status;
    }
    if (safety != 0) goto ERROR; return; ERROR:;
    return (main_retres11);
  }
}
