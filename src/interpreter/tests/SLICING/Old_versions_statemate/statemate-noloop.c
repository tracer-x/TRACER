...
void FH_DU()
{
   ...
   //     {
      ...
      generic_KINDERSICHERUNG_CTRL();  // function call #1
       ...
       generic_FH_TUERMODUL_CTRL();  // function call #2
       ...
       generic_EINKLEMMSCHUTZ_CTRL(); // function call #3
       ...
       generic_BLOCK_ERKENNUNG_CTRL(); // function call #4
