//////////////////////////////////////////////////////////////////////////////////////////
// Slice computed by CodeSurfer on main at <END,{options}>
//////////////////////////////////////////////////////////////////////////////////////////
...
/// EXTERNAL FUNCTIONS
/////////////////////////////////////////////////////////////////////////////
// int parse_socket_option(char *arg );
extern int atoi(char const   *__nptr );
//int parse_ssl_option(char *arg );
//int parse_debug_level(char *arg );
...
//char **argalloc(char *str );
/* int host2nums(char *hostname , u32 **hostlist ); */
/////////////////////////////////////////////////////////////////////////////
...
int main() 
{
	global_options(0, 0, 0);
/* 	service_options(0, 0, 0,0); */
	return 0;
	_SLICE(options);
}
