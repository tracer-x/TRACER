// Slice generated by CodeSurfer on 
// status,s, NP, pending, UNLOADED , DC , SKIP1 , SKIP2 , MPR1 , MPR3,
// IPC at the end of main.
	  ...
	  if(pCurDevObj != (void *  )0)
	    {
	      pExtension = (SERIAL_DEVICE_EXTENSION * 
			    )((PCHAR )pCurDevObj - (ULONG_PTR )(& ((SERIAL_DEVICE_EXTENSION * )0)->AllDevObjs)); 
	    }
	}
       ///////////////////////////////////////////////////////////////
       while(pCurDevObj != (void *  )0 && pCurDevObj != & SerialGlobals.AllDevObjs);	    
			      ...
			      DEVICE_POWER_STATE DevPowerState )
{
  ...
  status = PoRequestPowerIrp(PDevObj, 0x02, powerState,
			     temp_func /*SerialSystemPowerCompletion*/, & gotoPowEvent, (void *  )0);
  if(status == (NTSTATUS )0x00000103L)
    {
