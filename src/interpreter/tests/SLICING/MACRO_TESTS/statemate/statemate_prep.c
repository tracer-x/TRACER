...
// Replace array with variables by Jorge
static char B0;   
static char B1;
static char B2;
static char B3;
...
interface(void)
{
  ...
  if ((B0 || BLOCK_ERKENNUNG_CTRL__N != BLOCK_ERKENNUNG_CTRL__N_old))
...
main(void)
{
  ...
  return 0;
  _SLICE(BEWEGUNG_BLOCK_ERKENNUNG_CTRL_next_state,BLOCK_ERKENNUNG_CTRL_BLOCK_ERKENNUNG_CTRL_next_state);
}
