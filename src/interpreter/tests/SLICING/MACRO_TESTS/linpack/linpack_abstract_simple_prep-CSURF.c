...
// Sliced by CodeSurfer (Grammatech)
////////////////////////////////////////////////////////////////////////
...
/*   float resid,residn,eps; */
  float t1;
/*   float tm,tm2; */
/*   float kf; */
  static int n,i,ntimes;
/*   static int info,lda,ldaa,kflops; */

  int aup1 = 200;

  int aup2,aaup1, aaup2 ,bup ,xup, ipvtup ;
...
/*   int ipvtup = 200; */
  ...
  int tmp1;
/*   int tmp2, tmp3, tmp4, tmp5, tmp6, tmp7; */
  int tmp8;
/*   int tmp9, tmpa; */
