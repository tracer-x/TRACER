 ...
 *
 * This is modified from the original version to use division instead
 * of right shift, array accesses instead of pointers
 */
                    ...
                    long scale)
{
  ...
  long in = 0;     /* Originally the address of in_data */
  long out = 0;    /* Originally the address of output in main() */
  long coef = 0;   /* Originally the address of fir_int */
