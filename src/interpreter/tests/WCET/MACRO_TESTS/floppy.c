...
// This is actually for WCET, nothing to do with safety
...
/* 	                            formatExParameters->SectorsPerTrack *sizeof(USHORT ); */
  ...
  "\134\0R\0e\0g\0i\0s\0t\0r\0y\0\134\0M\0a\0c\0h\0i\0n\0e\0\134\0S\0y\0s\0t\0e\0m\0\134\0D\0I\0S\0K\0",
	    ...
	    /////////////////////////////////////////////////////////////////////
	    // It can be deleted because it doesn't affect the safety conditions.
	    /////////////////////////////////////////////////////////////////////
...
NTSTATUS FloppyStartDevice(PDEVICE_OBJECT DeviceObject , PIRP Irp )
{
  ...
  if((NTSTATUS )ntStatus >= 0)
      ...
      else
	{
	  ...
	  /*  } // end for-loop */
	  // POST: ntStatus is either 0x00000000L or 0xC0000001L.
	  // We achieve this by calling IoQueryDeviceDescription.
...
// TRACER: For now it's not reachable this function
...
NTSTATUS FlRecalibrateDrive(PDISKETTE_EXTENSION DisketteExtension )
{
  ...
  /////////////////////////////////////////////////////////////////
  // CAUTIOUS: we abstract the do-while
  /////////////////////////////////////////////////////////////////
...
/*************************************************************************/
/*************************************************************************/
/*    FloppyThread can be commented because it's never reachable.        */
/*************************************************************************/
/*************************************************************************/
...
/* 				 (DisketteExtension->FifoBuffer)[1](DisketteExtension->FifoBuffer)[2]); */
/* 			} */
/* 		    } */
/* 		    else{} */
/* 			     } */
...
void ExFreePool(PVOID P ){ return; }
