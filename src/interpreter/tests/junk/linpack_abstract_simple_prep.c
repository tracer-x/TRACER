...
int dgefa(int aup1, int aup2, int lda, int n, int ipvtup, int info)
{
  ...
  if (nm1 >= 0) {
    ...
    if (k+1 <= nm1) {
      ...
      if (tmp1) return tmp1;
# 816 "linpack_abstract_simple.c"
      if (tmp3) {

 if (l != k) {
# 828 "linpack_abstract_simple.c"
 }
...
# 960 "linpack_abstract_simple.c"
 ...
 if (l != k) {
# 1027 "linpack_abstract_simple.c"
 }
 kb++;
...
int idamax(int n, int dxup, int incx)
{
  ...
  if(incx != 1) {
    ...
    if (i+1 <= n) {
      int tmp2, tmp3, tmp4;
# 1269 "linpack_abstract_simple.c"
      if (tmp3) {
 itemp = i;
    ...
    if (i+1 <= n) {
      int tmp7, tmp8, tmp9;
# 1314 "linpack_abstract_simple.c"
      if (tmp8) {
 itemp = i;
...
# 1364 "linpack_abstract_simple.c"
...

{
  ...
  j = tmp2;
# 1414 "linpack_abstract_simple.c"
  if (j >= 2) {
    j = j - 1;
    ...
    if (i+1 <= n1) {
# 1433 "linpack_abstract_simple.c"
      i++;
  ...
  j = tmp3;
# 1463 "linpack_abstract_simple.c"
  if (j >= 4) {
    j = j - 1;
    i = 0;
    ...
    if (i+1 <= n1) {
# 1486 "linpack_abstract_simple.c"
      i++;
  ...
  j = tmp10;
# 1539 "linpack_abstract_simple.c"
  if (j >= 8) {
    j = j - 1;
    i = 0;
    ...
    if (i+1 <= n1) {
# 1572 "linpack_abstract_simple.c"
      i++;
  ...
  jmin = tmp11;
# 1626 "linpack_abstract_simple.c"
  j = jmin - 1;
  ...
  if (j+1 <= n2) {
    ...
    if (i+1 <= n1) {
# 1696 "linpack_abstract_simple.c"
      i++;
