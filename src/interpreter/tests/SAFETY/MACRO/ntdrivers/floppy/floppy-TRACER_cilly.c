...
enum _FILE_INFORMATION_CLASS {
    ...
    FileBothDirectoryInformation = 2,
    FileBasicInformation = 3,
    FileStandardInformation = 4,
    FileInternalInformation = 5,
    FileEaInformation = 6,
    FileAccessInformation = 7,
    FileNameInformation = 8,
    FileRenameInformation = 9,
    FileLinkInformation = 10,
    FileNamesInformation = 11,
    FileDispositionInformation = 12,
    FilePositionInformation = 13,
    FileFullEaInformation = 14,
    FileModeInformation = 15,
    FileAlignmentInformation = 16,
    FileAllInformation = 17,
    FileAllocationInformation = 18,
    FileEndOfFileInformation = 19,
    FileAlternateNameInformation = 20,
    FileStreamInformation = 21,
    FilePipeInformation = 22,
    FilePipeLocalInformation = 23,
    FilePipeRemoteInformation = 24,
    FileMailslotQueryInformation = 25,
    FileMailslotSetInformation = 26,
    FileCompressionInformation = 27,
    FileObjectIdInformation = 28,
    FileCompletionInformation = 29,
    FileMoveClusterInformation = 30,
    FileQuotaInformation = 31,
    FileReparsePointInformation = 32,
    FileNetworkOpenInformation = 33,
    FileAttributeTagInformation = 34,
    FileTrackingInformation = 35,
    FileMaximumInformation = 36
} ;
...
enum _FSINFOCLASS {
    ...
    FileFsSizeInformation = 2,
    FileFsDeviceInformation = 3,
    FileFsAttributeInformation = 4,
    FileFsControlInformation = 5,
    FileFsFullSizeInformation = 6,
    FileFsObjectIdInformation = 7,
...
enum __anonenum_DISK_CACHE_RETENTION_PRIORITY_91 {
    EqualPriority = 0,
...
void *memcpy(void *p , void const   *k , size_t t ) 
{ void *x ;
...
void *memset(void *p , int k , size_t t ) 
{ void *x ;
...
extern int ( /* missing proto */  _ABORT)() ;
...
{ KIRQL oldIrql ;
  ...
  if (DisketteExtension->ThreadReferenceCount == 0L) {
    ...
    status = PsCreateSystemThread(& threadHandle, 0UL, & ObjAttributes, (void *)0L, (CLIENT_ID *)((void *)0), MyFloppyThread, (void *)DisketteExtension);
    if (! (status >= 0L)) {
      DisketteExtension->ThreadReferenceCount = -1L;
      ExAcquireFastMutex(PagingMutex);
      PagingReferenceCount = PagingReferenceCount - 1UL;
...
{ PIO_STACK_LOCATION irpSp ;
  ...
  ExReleaseFastMutex(& disketteExtension->HoldNewReqMutex);
  if (MydisketteExtensionIsRemoved) {
    Irp->IoStatus.Information = 0UL;
  ...
  ntStatus = 0L;
  if (outputBufferLength < (ULONG )(sizeof(DISK_GEOMETRY ) * (((unsigned int )highestDriveMediaType - (unsigned int )lowestDriveMediaType) + 1U))) {
    ntStatus = -2147483643L;
...
{ NTSTATUS ntStatus ;
  ...
  if (ntStatus >= 0L) {
    ...
    if (fdcInfo.AcpiBios) {
      ...
      while ((unsigned int )InterfaceType < 17U) {
...
{ PDISKETTE_EXTENSION disketteExtension ;
  ...
  if ((unsigned int )type == 0U) {
    if ((unsigned int )state.SystemState > 5U) {
      ntStatus = 0L;
      break;
    }
  }
  ...
  if ((unsigned int )type == 0U) {
    ExAcquireFastMutex(& disketteExtension->PowerDownMutex);
    if ((unsigned int )state.SystemState == 1U) {
...
{ PIO_STACK_LOCATION irpSp ;
  ...
  if ((unsigned int )disketteExtension->MediaType > 0U) {
...
{ LARGE_INTEGER delay ;
  ...
  *(DriveMediaConstants + (DriveMediaLimits + DisketteExtension->DriveType)->HighestDriveMediaType) = DisketteExtension->BiosDriveMediaConstants;
  if ((unsigned int )DisketteExtension->MediaType == 4294967295U) {
  ...
  if (SetUpMedia) {
    if ((unsigned int )DisketteExtension->MediaType == 4294967295U) {
      ...
      if ((unsigned int )DisketteExtension->MediaType == 0U) {
        ...
        if ((unsigned int )DisketteExtension->DriveMediaType != (unsigned int )DisketteExtension->LastDriveMediaType) {
...
{ PIRP irp ;
  ...
  while (1) {
    ...
    if (waitStatus == 258L) {
      if (! ((unsigned int )((KUSER_SHARED_DATA * const  )4292804608U)->AlternativeArchitecture == 1U)) {
        if (disketteExtension->FloppyControllerAllocated) {
          FlFdcDeviceIo(disketteExtension->TargetObject, (unsigned long )(((7 << 16) | (775 << 2)) | 3), (void *)0);
          FlFdcDeviceIo(disketteExtension->TargetObject, (unsigned long )(((7 << 16) | (769 << 2)) | 3), (void *)disketteExtension->DeviceObject);
          disketteExtension->FloppyControllerAllocated = (unsigned char)0;
        }
      }
      ExAcquireFastMutex(& disketteExtension->ThreadReferenceMutex);
      if (disketteExtension->ThreadReferenceCount == 0L) {
        ...
        if ((unsigned int )((KUSER_SHARED_DATA * const  )4292804608U)->AlternativeArchitecture == 1U) {
          if (disketteExtension->ReleaseFdcWithMotorRunning) {
            ntStatus = FlFdcDeviceIo(disketteExtension->TargetObject, (unsigned long )(((7 << 16) | (768 << 2)) | 3), (void *)(& acquireWait));
            FlFdcDeviceIo(disketteExtension->TargetObject, (unsigned long )(((7 << 16) | (775 << 2)) | 3), (void *)0);
            FlFdcDeviceIo(disketteExtension->TargetObject, (unsigned long )(((7 << 16) | (769 << 2)) | 3), (void *)disketteExtension->DeviceObject);
            disketteExtension->FloppyControllerAllocated = (unsigned char)0;
            disketteExtension->ReleaseFdcWithMotorRunning = (unsigned char)0;
    ...
    while (request) {
      ...
      if ((int )irpSp->MinorFunction == 1) {
        ...
        if ((int )irpSp->MinorFunction == 5) {
          ...
          if ((unsigned int )((KUSER_SHARED_DATA * const  )4292804608U)->AlternativeArchitecture == 1U) {
            if (disketteExtension->ReleaseFdcWithMotorRunning) {
              FlFdcDeviceIo(disketteExtension->TargetObject, (unsigned long )(((7 << 16) | (768 << 2)) | 3), (void *)(& acquireWait));
              disketteExtension->ReleaseFdcWithMotorRunning = (unsigned char)0;
      ...
      if ((disketteExtension->DeviceObject)->Flags & 2UL) {
        ...
        if ((unsigned int )((KUSER_SHARED_DATA * const  )4292804608U)->AlternativeArchitecture == 1U) {
          ...
          ntStatus = FlIssueCommand(disketteExtension, disketteExtension->FifoBuffer, disketteExtension->FifoBuffer, (struct _MDL *)((void *)0), 0UL, 0UL);
          if (ntStatus >= 0L) {
            outputBuffer2 = (struct _SENSE_DEVISE_STATUS_PTOS *)irp->AssociatedIrp.SystemBuffer;
            outputBuffer2->ST3_PTOS = Result_Status3_PTOS[0].ST3_PTOS;
...
{ USHORT bpbNumberOfSectors ;
  ...
  if ((unsigned int )bpbMediaType == (unsigned int )DisketteExtension->MediaType) {
    ...
    if ((unsigned int )bpbMediaType == 0U) {
  ...
  if (changeToBpbMedia) {
    ...
    while (i <= n) {
      if ((unsigned int )bpbMediaType == (unsigned int )(DriveMediaConstants + i)->MediaType) {
    ...
    tmp = RtlCompareMemory((void *)(BootSector->OemData), (void *)"MSDMF3.", 7UL);
    if (tmp == 7UL) {
...
{ PBOOT_SECTOR_INFO bootSector ;
  ...
  {
  tmp = ExAllocatePoolWithTag((enum _POOL_TYPE )4, 1024UL, tag__1);
...
{ PIO_STACK_LOCATION irpSp ;
  ...
  while (currentSector < lastSector) {
    ...
    if (trackSize > DisketteExtension->MaxTransferSize) {
      ...
      ioOffset = 0UL;
      if (writeOperation) {
        memmove(ioBuffer, userBuffer + ((currentSector - firstSector) << byteToSectorShift), (unsigned long )numTransferSectors << byteToSectorShift);
      }
    } else {
      mdl = Irp->MdlAddress;
    ...
    status = FlReadWriteTrack(DisketteExtension, mdl, ioOffset + (((unsigned long )skew - (unsigned long )trackSector) << byteToSectorShift), writeOperation, currentCylinder, currentHead, skew, (unsigned char )(((int )numTransferSectors + (int )trackSector) - (int )skew), (unsigned char)1);
    if (status >= 0L) {
      if ((int )skew > (int )trackSector) {
    ...
    if (! writeOperation) {
      if (trackSize > DisketteExtension->MaxTransferSize) {
        memmove(userBuffer + ((currentSector - firstSector) << byteToSectorShift), ioBuffer, (unsigned long )numTransferSectors << byteToSectorShift);
      }
    }
...
{ LARGE_INTEGER headSettleTime ;
  ...
  while (1) {
    if ((unsigned int )(DriveMediaConstants + driveMediaType)->MediaType != (unsigned int )formatParameters->MediaType) {
      if (! ((unsigned int )driveMediaType > (unsigned int )(DriveMediaLimits + DisketteExtension->DriveType)->LowestDriveMediaType)) {
        break;
      }
    } else {
      break;
  ...
  if ((unsigned int )DisketteExtension->LastDriveMediaType != (unsigned int )driveMediaType) {
    ntStatus = FlDatarateSpecifyConfigure(DisketteExtension);
    if (! (ntStatus >= 0L)) {
      return (ntStatus);
    }
...
{ PDRIVE_MEDIA_CONSTANTS ddriveMediaConstants ;
  ...
  if ((unsigned int )(DriveMediaConstants + driveMediaType)->MediaType != (unsigned int )FormatParameters->MediaType) {
    ...
    if (FormatParameters->StartHeadNumber > (unsigned long )((int )ddriveMediaConstants->NumberOfHeads - 1)) {
      return ((unsigned char)0);
    } else {
      if (FormatParameters->EndHeadNumber > (unsigned long )((int )ddriveMediaConstants->NumberOfHeads - 1)) {
        return ((unsigned char)0);
      } else {
        if (FormatParameters->StartCylinderNumber > (ULONG )ddriveMediaConstants->MaximumTrack) {
          return ((unsigned char)0);
        } else {
          if (FormatParameters->EndCylinderNumber > (ULONG )ddriveMediaConstants->MaximumTrack) {
            return ((unsigned char)0);
          } else {
        ...
        if (! (status == -1L)) {
          ...
          if (pended == 1) {
            ...
            if (s == DC) {
              ...
              _ABORT(status != (NTSTATUS )lowerDriverReturn);
            }
          }
        }
      }
