...
// #line 9423
extern void KeClearEvent(PRKEVENT Event ){}
...
// #line 18271
 NTSTATUS PoCallDriver(PDEVICE_OBJECT DeviceObject , PIRP
	Irp ) ;
// #line 18278
 void PoStartNextPowerIrp(PIRP Irp ) ;
// #line 18285
 PULONG PoRegisterDeviceForIdleDetection(PDEVICE_OBJECT
...
NTSTATUS SerialFindInitController(PDEVICE_OBJECT PDevObj , PCONFIG_DATA PConfig)
{
  ...
  if(! PConfig->Jensen && pCurDevObj != (void *  )0)
	...
	// TRACER while(pCurDevObj != (void *  )0 && pCurDevObj != & SerialGlobals.AllDevObjs);	    
    }
  return (NTSTATUS )0x00000000L;
}
...
void SerialDrainUART(PSERIAL_DEVICE_EXTENSION PDevExt , PLARGE_INTEGER PDrainTime )
{
  ...
  while(__BLAST_NONDET/* (READ_PORT_UCHAR(PDevExt->Controller + (ULONG )(0x05 * 1)) &  */
/* 	 (0x20 | 0x40)) != (0x20 | 0x40) */)
...
/*     } */
  ...
  if(extension->RXHolding & (ULONG )0x02)
    {
      while(__BLAST_NONDET /* ! (READ_PORT_UCHAR(extension->Controller + (ULONG )(0x05 * */
/* 								1)) & 0x20) */)
	{
	  KeDelayExecutionThread(KernelMode, 0, & charTime);
	}
...
/*       while(0); */
      ...
      for(flushCount = __BLAST_NONDET; flushCount != 0; flushCount--)
	{
	  if(__BLAST_NONDET/* (READ_PORT_UCHAR(extension->Controller + (ULONG */
