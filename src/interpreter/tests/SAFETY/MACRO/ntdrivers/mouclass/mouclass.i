	...
	)
{
	...
	(Globals.RegistryPath).Buffer = ExAllocatePoolWithTag(NonPagedPool,
		(Globals.RegistryPath).MaximumLength, 'CouM');
	#line 226
	...
	#line 243
	memmove((Globals.RegistryPath).Buffer, RegistryPath->Buffer,
		RegistryPath->Length);
	#line 244
	((Globals.RegistryPath).Buffer)[RegistryPath->Length / sizeof(WCHAR )] =
		"\0\0";
	#line 250
	MouConfiguration();
	#line 257
