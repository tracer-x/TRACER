...
unsigned alt_sep_test()
{
    ...
    if (enabled && ((tcas_equipped && intent_not_known) || !tcas_equipped))
    {
	  ...
	  /*property2b(alim) ;*/
	  if(Up_Separation < alim && Down_Separation < alim && Up_Separation < Down_Separation) ERROR: goto ERROR;
	  //_ABORT(Up_Separation < alim && Down_Separation < alim && Up_Separation < Down_Separation);
	  //_DECOMPILE_ABORT(Up_Separation < alim && Down_Separation < alim && Up_Separation < Down_Separation);
	  /*property3b(alim) ;*/
