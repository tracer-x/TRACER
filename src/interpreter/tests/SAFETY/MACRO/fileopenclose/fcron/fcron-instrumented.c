...
# 258
  ...
  {
# 64 "spec.work"
  if (! (daemon_lockfp->__BLAST_FLAG == 1)) {
# 66
    __error__();
  }
  {
...
# 80
  ...
  {
# 83
  len = vsnprintf((char */* __restrict  */)msg, 176U,
...
# 1049
  if ((int )context == 2) {
    {
# 1051
    previous_period = line->cl_nextexe -
                      (long )((int )(line->cl_file)->cf_tzdiff * 3600);
# 1052
...
# 94
      ...
      {
# 96
      tmp___2 = strncmp((char const   *)(den->d_name), (char const   *)"rm.", 3U);
      }
# 96
      if (tmp___2 == 0) {
        {
...
# 457
  ...
  {
# 468
  tmp___0 = strncmp(file_name, (char const   *)"new.", 4U);
  }
# 468
  if (tmp___0 == 0) {
# 469
...
# 1038
    ...
    {
# 1043
    save_file_safe(file, file->cf_user, "fcron", 0U, 0U, now);
    }
# 1045
    if ((unsigned int )arg_file != (unsigned int )((void *)0)) {
# 1047
...
# 706
  master_set.__fds_bits[(unsigned int )((*client))->fcl_sock_fd /
                        (8U * sizeof(__fd_mask ))] = master_set.__fds_bits[(unsigned int )((*client))->fcl_sock_fd /
                                                                           (8U *
                                                                            sizeof(__fd_mask ))] &
                                                     ~ (1L <<
...
# 779
    if (read_set.__fds_bits[(unsigned int )client->fcl_sock_fd /
                            (8U * sizeof(__fd_mask ))] &
