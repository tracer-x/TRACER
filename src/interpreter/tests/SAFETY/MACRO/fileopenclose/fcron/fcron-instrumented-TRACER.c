...
// # 3
/////////////////////////////////////////////////////////
// If this function is called then there is an error.
/////////////////////////////////////////////////////////
void BLAST_ERROR(void) 
{ 
  int FRESHVAR;
  BLAST_error = 0;
  _TRACER_abort(FRESHVAR >0);  
  // ERROR: goto ERROR;     
}
...
{ char *tmp ;
  ...
  if ((int )foreground == 0) {
    ...
    pid = fork();
    // # 528
/* This switch causes problems with ANTRL compilation. Don't know why ... */
/*     switch (pid) { */
/*     case -1:  */
/*       // # 530 */
/*       die_e("fork"); */
