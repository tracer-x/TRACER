...
{ 
...

  {
	...
	else if(blastFlag == 10) blastFlag = 11;
	else _TRACER_abort(blastFlag == 13); //if(blastFlag == 13) goto ERROR;
	if (ret <= 0) {
	  goto end;
	}
	...
	else if(blastFlag == 5) blastFlag = 6;
	else if(blastFlag == 8) blastFlag = 9;
	else if(blastFlag == 11) blastFlag = 12;
	if (ret <= 0) {
	  goto end;
	}
	...
	else if(blastFlag == 6) blastFlag = 7;
	else if(blastFlag == 9) blastFlag = 10;
