...
extern int ( /* missing proto */  _TRACER_abort)() ;
...
{ int s__info_callback ;
  ...
  while (1) {
    ...
    switch(s__state) {
        ...
        s__state = 4352;
        CIL___tmp57 = (long )s__s3__flags;
        CIL___tmp58 = CIL___tmp57 + 5L;
        s__s3__flags = (int )CIL___tmp58;
        if (s__hit) {
          s__s3__tmp__next_state___0 = 3;
          CIL___tmp59 = (long )s__s3__flags;
          if (CIL___tmp59 - 2L) {
            s__state = 3;
            CIL___tmp60 = (long )s__s3__flags;
            CIL___tmp61 = CIL___tmp60 + 4L;
            s__s3__flags = (int )CIL___tmp61;
        ...
        CIL___tmp64 = (long )s__s3__flags;
        CIL___tmp65 = CIL___tmp64 - 4L;
        if (! CIL___tmp65) {
