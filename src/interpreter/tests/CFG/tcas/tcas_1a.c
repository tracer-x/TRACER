...
{
    register unsigned upward_preferred /* = 0 */ ;
    register unsigned upward_crossing_situation;
    //bool result = 0 ;
    // unsigned alim = ALIM() ;
    // New variables added ...
    register bool result;
    register unsigned alim;    
    register unsigned temp1;
    register bool temp2,temp3;
...
{
    register bool enabled=0, tcas_equipped=0, intent_not_known=0;
    register bool need_upward_RA=0, need_downward_RA=0;
    register unsigned alt_sep;
    // The compiler fails here
    //unsigned alim = ALIM() ;
    register unsigned alim;
    // New variables added ....
    register bool temp1,temp2,temp3,temp4;
