// This version is compiled by gcc
...
int matgen(register int aup1, register int aup2, register int lda, register int n, register int bup, register float norma)
{
...
int dgefa(int aup1, int aup2, int lda, int n, int ipvtup, int info)
{
 ...
 info = k;
  ...
  if (((n-1) + (n-1)<=-1) || ((n-1) + (n-1)>=(aup1))) return 1;
  if (tmp4) { info = n - 1; }
  return 0;
}
...
int daxpy(int n, int da, int dx, int incx, int dy, int incy)


{
  register int i,ix,iy,m,mp1;
  register int tmp1, tmp2;
  register int dxup,dyup ;
...
int dscal(int n, int da, int dxup, int incx)
{
...

{
  ...
  register int tmp5, tmp6, tmp7, tmp8, tmp9, tmp10, tmp11;
  register int tmp4;
...
main ()
{
  ...
  register int aup1 = 200;
  register int aup2 = 201;
  register int aaup1 = 200;
  register int aaup2 = 200;
  register int bup = 200;
  register int xup = 200;
  register int ipvtup = 200;

  register int tmp1, tmp2, tmp3, tmp4, tmp5, tmp6, tmp7;
  register int tmp8, tmp9, tmpa;

  register int tmp10, tmp11, tmp12, tmp13, tmp14, tmp15;
  register int tmp16;
