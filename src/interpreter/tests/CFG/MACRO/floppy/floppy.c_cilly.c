...
{ PIRP irp ;
  ...
  while (i < 5) {
    ...
    if (waitStatus == 258L) {
      if (! ((unsigned int )((KUSER_SHARED_DATA *)4292804608U)->AlternativeArchitecture == 1U)) {
...
{ KIRQL oldIrql ;
  ...
  while ((unsigned int )headOfList != (unsigned int )((void *)0)) {
