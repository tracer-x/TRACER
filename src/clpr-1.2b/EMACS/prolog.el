;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; Note by Jorge Navas (24/06/09). 
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; A rough emacs mode for CLP(R) has been achived by using the emacs
;; mode for SWI-Prolog only replacing with the keywords and the
;; executable name of CLP(R). The rest of features are from SWI-Prolog.
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
(defcustom prolog-keywords
  '((eclipse
    ...
    (swi ;; + CLP(R) keywords
     ("all" "codegen_debug" "codegen_nodebug" "consult" "discontiguous" "dynamic"
      "ensure_loaded" "export" "export_list" "implicit" "import" "meta_predicate" 
      "module" "module_transparent" "multifile"  "name_overload" "noimplicit" 
      "no_style_check"  "nospy" "notrace" "op" "partial_implicit" "reconsult" 
      "require" "spy" "single_var" "style_check" "trace" "use_module" "volatile" ))
;;     (swi
...
;;    (t ,(let ((names '("prolog" "gprolog" "swipl" "pl")))
    (t ,(let ((names '("prolog" "gprolog" "clpr" "swipl" "swi" "pl")))
 	  (while (and names
