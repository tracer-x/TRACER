 ...
 * Changes made by Vijay for 64-bit risci8 machine (node size = 48 bytes)
 * IMPORTANT: compiler automatically aligns structs to nearest n-multiple
 *            greater than its size, where n is the size of the largest
 *            element in the struct (ptr = 8, int = 4 on 64-bit system).
 *********************************************************************/
